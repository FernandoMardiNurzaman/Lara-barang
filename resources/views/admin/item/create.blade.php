        ...
        <div class="card-body">
            ...
            <form action="{{ route("item.store") }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="condition_id"
                                ...
                                <option value="{{ $data->id }}">{{ $data->condition_name }}</option>
                                @endforeach
                            </select>
                            @error('condition_id')
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="form-group">
                    ...
                    <textarea name="fromWhere" class="form-control @error('fromWhere') is-invalid @enderror"
                        value="{{ old('fromWhere') }}">
                    </textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="fault_items" class=" form-control @error('fault_items') is-invalid @enderror"
                        value="{{ old('fault_items') }}" placeholder="Silahkan Di isi Jika Ada!">
                    </textarea>
                ...
                {{-- <div class="form-group">
                    <label>Penyimpanan/Gudang :</label>
                    <select name="locker_id" class="form-control @error('locker_id') is-invalid @enderror">
                        <option value="">--pilih--</option>
                        @foreach ($locker as $data)
                        <option value="{{ $data->id }}">{{ $data->locker_id }}</option>
                @endforeach
                </select>
                @error('category_id')
                <span class="invalid-feedback" role="alert">
