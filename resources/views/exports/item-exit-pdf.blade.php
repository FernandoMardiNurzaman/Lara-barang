...
<body>
    <div class="container">
        <div class="mt-2 text-center">
            <h3>{{ $itemExit->item->item_name }}-{{ $itemExit->item->code }}</h3>
            <br>
            <br>
            <img src="{{ public_path('uploads\images') . "/" . $itemExit->item->photo }}" alt="img"
                class="img-rounded mt-5" width="500">
        ...
        <div class="mt-2">
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    <th>Kerusakan</th>
                    <td>{{$itemExit->item->fault_items}}</td>
                </tr>
                <tr>
        ...
        <div class="row text-right mt-5">
            <span class="mt-5 text-muted">Di-print pada {{ date('d-M-Y') }}, ip
                {{ Request::ip() }}</span>
        </div>
    </div>
